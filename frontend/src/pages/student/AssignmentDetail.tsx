    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          <div className="space-y-2">
            <span className="inline-block text-xs font-mono font-bold text-indigo-300 bg-indigo-950/80 border border-indigo-500/30 px-3 py-1 rounded-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card className="flex items-center gap-4">
          <div className="w-11 h-11 rounded-2xl bg-violet-950/80 border border-violet-500/30 flex items-center justify-center text-violet-300 shrink-0 shadow-md">
            <FiCalendar size={20} />
          </div>
          <div>
            <p className="text-xs text-slate-400 uppercase tracking-wider font-bold">Due Date</p>
        ...
        <Card className="flex items-center gap-4">
          <div className="w-11 h-11 rounded-2xl bg-amber-950/80 border border-amber-500/30 flex items-center justify-center text-amber-300 shrink-0 shadow-md">
            <FiClock size={20} />
          </div>
          <div>
            <p className="text-xs text-slate-400 uppercase tracking-wider font-bold">Cutoff Date</p>
            <p className="text-sm font-bold text-white">
        ...
        <Card className="flex items-center gap-4 sm:col-span-2 lg:col-span-1">
          <div className="w-11 h-11 rounded-2xl bg-indigo-950/80 border border-indigo-500/30 flex items-center justify-center text-indigo-300 shrink-0 shadow-md">
            <FiLayers size={20} />
          </div>
          <div>
            <p className="text-xs text-slate-400 uppercase tracking-wider font-bold">Course Details</p>
      ...
      <Card className="space-y-3">
        <h3 className="text-xs font-bold text-slate-200 uppercase tracking-wider flex items-center gap-2">
          <FiInfo size={15} className="text-violet-400" />
          Assignment Description & Instructions
        </h3>
        <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 text-sm font-medium text-slate-200 leading-relaxed whitespace-pre-line">
      ...
      <Card className="space-y-3 !py-4">
        <h4 className="text-xs font-bold text-slate-300 uppercase tracking-wider">Sync Metadata</h4>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
          <div className="flex flex-col">
            <span className="text-slate-400 font-medium">Moodle Assignment ID</span>
            <span className="font-mono text-slate-200 font-bold">{assignment.moodleAssignmentId || 'N/A'}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-slate-400 font-medium">First Discovered</span>
            <span className="text-slate-200 font-semibold">{firstSeenDate ? format(firstSeenDate, 'MMM d, yyyy h:mm a') : '—'}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-slate-400 font-medium">Last Verified</span>
            <span className="text-slate-200 font-semibold">{lastCheckedDate ? format(lastCheckedDate, 'MMM d, yyyy h:mm a') : '—'}</span>
          </div>
        </div>
      </Card>
    </div>

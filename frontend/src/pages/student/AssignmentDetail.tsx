    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          <div className="space-y-2">
            <span className="inline-block text-xs font-mono font-semibold text-indigo-300 bg-indigo-500/10 border border-indigo-500/20 px-3 py-1 rounded-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card className="flex items-center gap-4">
          ...
          <div>
            <p className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">Due Date</p>
        ...
        <Card className="flex items-center gap-4">
          ...
          <div>
            <p className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">Cutoff Date</p>
            <p className="text-sm font-bold text-white">
        ...
        <Card className="flex items-center gap-4 sm:col-span-2 lg:col-span-1">
          ...
          <div>
            <p className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">Course Details</p>
      ...
      <Card className="space-y-3">
        ...
        <div className="p-4 rounded-2xl bg-slate-900/50 border border-white/5 text-sm text-slate-300 leading-relaxed whitespace-pre-line">
      ...
      <Card className="space-y-3 !py-4">
        <h4 className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Sync Metadata</h4>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
          <div className="flex flex-col">
            <span className="text-slate-500">Moodle Assignment ID</span>
            <span className="font-mono text-slate-300 font-semibold">{assignment.moodleAssignmentId || 'N/A'}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-slate-500">First Discovered</span>
            <span className="text-slate-300">{firstSeenDate ? format(firstSeenDate, 'MMM d, yyyy h:mm a') : '—'}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-slate-500">Last Verified</span>
            <span className="text-slate-300">{lastCheckedDate ? format(lastCheckedDate, 'MMM d, yyyy h:mm a') : '—'}</span>
          </div>
        </div>
      </Card>
    </div>
